"""Scrape 100 transcripts per AI influencer using Whisper tiny model."""
...
def get_existing_transcripts(influencer):
    """Get video IDs and count of existing transcripts."""
...
def search_videos(influencer, max_results=120):
    ...
    # Try multiple search queries to get more diverse results
    queries = [
