"""Scrape 100 Aitana Lopez video transcripts using Whisper."""
...
OUTPUT_ROOT = r"c:\Users\isha and gaurav\OneDrive\Desktop\yt-influe\Youtube-engagement-analysis-with-scraper\output\ai_influencers"
INFLUENCER = "Aitana Lopez"
OUTPUT_DIR = os.path.join(OUTPUT_ROOT, INFLUENCER)
FILENAME = f"{INFLUENCER}.jsonl"
TARGET = 100
...
def main():
    ...
    print("\n" + "="*70)
    print(f"{INFLUENCER} - Scrape {TARGET} Transcripts")
    print("="*70)
    ...
    for idx, video in enumerate(new_videos, 1):
        ...
        if transcript and len(transcript) > 50:
            ...
            print("✗ Failed (or transcript too short)")
            failed += 1
