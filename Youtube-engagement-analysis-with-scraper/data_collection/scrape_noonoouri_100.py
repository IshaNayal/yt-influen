"""Scrape top 100 Noonoouri AI influencer transcripts."""
...
OUTPUT_DIR = r"c:\Users\isha and gaurav\OneDrive\Desktop\yt-influe\Youtube-engagement-analysis-with-scraper\output\ai_influencers\Noonoouri"
...
def get_highest_count():
    ...
    filepath = os.path.join(OUTPUT_DIR, "noonoouri-transcripts.jsonl")
    max_count = 0
...
def main():
    ...
    print("\n" + "="*70)
    print(f"Noonoouri - Digital Influencer & Model - Top {TARGET} Transcripts")
    print("="*70)
    ...
    # Search for Noonoouri - Digital Influencer from Germany, Fashion, Art, Sustainability, NFTs, Metaverse, High Fashion
    all_videos_dict = {}
    queries = [
        "Noonoouri Munich Germany digital influencer",
        "Noonoouri IMG Models interview",
        "Noonoouri Versace collaboration",
        "Noonoouri Balenciaga fashion",
        "Noonoouri haute couture",
        "Noonoouri sustainability fashion",
        "Noonoouri NFT metaverse",
        "Noonoouri digital avatar art",
        "Noonoouri fashion designer",
        "Noonoouri haute couture show",
        "Noonoouri diversity inclusion",
        "Noonoouri virtual model",
        "Noonoouri Paris lifestyle",
        "Noonoouri art technology",
    ]
