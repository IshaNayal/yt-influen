"""Scrape top 100 Shudu Gram AI influencer transcripts."""
...
OUTPUT_DIR = r"c:\Users\isha and gaurav\OneDrive\Desktop\yt-influe\Youtube-engagement-analysis-with-scraper\output\ai_influencers\Shudu Gram"
INFLUENCER = "Shudu Gram"
TARGET = 100
...
def get_highest_count():
    ...
    filepath = os.path.join(OUTPUT_DIR, "shudu-gram-transcripts.jsonl")
    max_count = 0
...
def main():
    ...
    print("\n" + "="*70)
    print(f"Shudu Gram - World's First Black Virtual Supermodel - Top {TARGET} Transcripts")
    print("="*70)
    ...
    # Search for Shudu Gram - First Black Virtual Supermodel, Fashion Industry, Vogue, Photography, Editorial
    all_videos_dict = {}
    queries = [
        "Shudu first black virtual supermodel",
        "Shudu Gram Vogue magazine",
        "Shudu Gram fashion photography",
        "Shudu Gram Cameron James Wilson",
        "Shudu editorial fashion",
        "Shudu model photoshoot",
        "Shudu luxury fashion",
        "Shudu Gram interview supermodel",
        "Shudu diversity fashion industry",
        "Shudu virtual model runway",
        "Shudu fashion trends",
        "Shudu brand collaboration",
        "Shudu Gram breaking barriers",
        "Shudu fashion innovation",
        "Shudu model portfolio",
    ]
