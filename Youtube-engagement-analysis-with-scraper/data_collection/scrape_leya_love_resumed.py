"""Scrape top 100 Leya Love AI influencer transcripts - RESUMED."""
import os
import json
import tempfile
import glob
...
def main():
    ...
    print(f"\n{'='*70}\nLeya Love - UN Speaker & Consciousness Advocate - Top {TARGET} Transcripts (RESUMED)\n{'='*70}\nCurrent: {highest}, Target: {TARGET}\nNeed: {max(0, TARGET - highest)} more\n")
    model = whisper.load_model("tiny")
    existing_ids = get_existing_video_ids()
    print(f"Already have: {len(existing_ids)} videos\n")
    all_videos_dict = {}
    queries = ["Leya Love United Nations", "Leya Love World Awareness Movement", "Leya Love climate activism", "Leya Love consciousness", "Leya Love Planet Earth", "Leya Love sustainability", "Leya Love mental health", "Leya Love Life Values", "Leya Love speaker", "leyalovenature", "Leya Love planet ambassador", "Leya Love humanity"]
    for q in queries:
