"""Scrape top 100 Leya Love AI influencer transcripts."""
...
def main():
    ...
    print("\n" + "="*70)
    print(f"Leya Love AI - Scraping Top {TARGET} Transcripts")
    print("="*70)
    ...
    # Search for Leya Love - UN Speaker, World Awareness, Climate Activism, Consciousness
    all_videos_dict = {}
    queries = [
        "Leya Love United Nations",
        "Leya Love World Awareness Movement",
        "Leya Love climate activism",
        "Leya Love consciousness",
        "Leya Love Planet Earth",
        "Leya Love sustainability",
        "Leya Love mental health",
        "Leya Love Life Values",
        "Leya Love speaker",
        "leyalovenature United Nations",
        "Leya Love planet ambassador",
        "Leya Love humanity",
    ]
