"""Add 1 more Lil Miquela transcript using Whisper - with multiple searches."""
...
def main():
    ...
    print("\n" + "="*70)
    print("Lil Miquela - Adding 1 More Transcript")
    print("="*70)
    ...
    for query in queries:
        ...
        videos = search_videos(query, max_results=30)
    ...
    new_videos = [v for vid, v in all_videos.items() if vid not in existing_ids]
    ...
    if new_videos:
        ...
        print(f"#{count_num} {title}...", end=" ", flush=True)
