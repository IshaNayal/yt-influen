"""Scrape top 100 Leya Love transcripts using Whisper."""
...
def main():
    ...
    print("\n" + "="*70)
    print(f"Leya Love - Scraping Top {TARGET} Transcripts")
    print("="*70)
    print(f"\nCurrent highest count: {highest}")
    print(f"Target: {TARGET} total transcripts\n")
    ...
    for idx, video in enumerate(new_videos, 1):
        if highest + added >= TARGET:
            print(f"\nReached target of {TARGET} transcripts!")
            break
