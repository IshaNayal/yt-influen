"""Add 2 more Lil Miquela transcripts using Whisper with yt-dlp."""
...
def main():
    ...
    print("\n" + "="*70)
    print(f"Lil Miquela - Adding {TARGET_NEW_TRANSCRIPTS} More Transcripts")
    print("="*70)
    
    print(f"\nCurrent highest count: {highest}")
    print(f"Will add: {highest + 1} to {highest + TARGET_NEW_TRANSCRIPTS}")
    ...
    for query in search_queries:
        ...
        videos = search_videos(query, max_results=40)
    ...
    print(f"Final highest count: {final_count}")
    print("="*70 + "\n")
